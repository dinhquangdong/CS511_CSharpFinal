...
namespace Final.DTO
{
    public class Account
    {
        ...
        public Account(DataRow row)
        {
            ...
            this.A00 = float.Parse(row["A00"].ToString());
            this.A01 = float.Parse(row["A01"].ToString());
            this.A02 = float.Parse(row["A02"].ToString());
            this.B00 = float.Parse(row["B00"].ToString());
            this.B01 = float.Parse(row["B01"].ToString());
            this.B02 = float.Parse(row["B02"].ToString());
            this.C00 = float.Parse(row["C00"].ToString());
            this.C01 = float.Parse(row["C01"].ToString());
            this.C02 = float.Parse(row["C02"].ToString());
            this.C03 = float.Parse(row["C03"].ToString());
            this.D01 = float.Parse(row["D01"].ToString());
            this.D07 = float.Parse(row["D07"].ToString());
            this.H00 = float.Parse(row["H00"].ToString());
            this.T00 = float.Parse(row["T00"].ToString());
            this.T03 = float.Parse(row["T03"].ToString());
            this.T04 = float.Parse(row["T04"].ToString());
            this.T05 = float.Parse(row["T05"].ToString());
            this.T06 = float.Parse(row["T06"].ToString());
        }
